...
- Recommend labels from: `bug`, `enhancement`, `documentation`, `question`, `duplicate`, `needs-triage`, `needs-author-feedback`, `sample-<FeatureName>`, etc.
...
- Suggest 2-3 potential assignees with context: `@<username> - <reason>` (e.g., "fixed similar sample issue in #12345", "maintains AppLifecycle samples")
