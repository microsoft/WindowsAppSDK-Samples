...
namespace SDKTemplate
{
    public sealed partial class Scenario4_ForegroundGeofence : Page
    {
        ...
        {
            App.MainWindow.VisibilityChanged += OnVisibilityChanged;
        ...
        private void OnVisibilityChanged(object sender, WindowVisibilityChangedEventArgs args)
        {
            ...
            if (geofenceMonitor != null)
            {
                ...
                {
                    // unregister foreground events while the app is hidden
                    geofenceMonitor.GeofenceStateChanged -= OnGeofenceStateChanged;
                    geofenceMonitor.StatusChanged -= OnGeofenceStatusChanged;
                }
            }
        ...
        public void OnGeofenceStatusChanged(GeofenceMonitor sender, object e)
        {
        ...
        public void OnGeofenceStateChanged(GeofenceMonitor sender, object e)
        {
