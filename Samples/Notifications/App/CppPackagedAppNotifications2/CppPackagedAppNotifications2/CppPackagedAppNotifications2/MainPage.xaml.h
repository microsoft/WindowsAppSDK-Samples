...
namespace winrt::CppPackagedAppNotifications2::implementation
{
    ...
    {
        MainPage();
        static CppPackagedAppNotifications2::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<CppPackagedAppNotifications2::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static CppPackagedAppNotifications2::MainPage current;
    };
}
