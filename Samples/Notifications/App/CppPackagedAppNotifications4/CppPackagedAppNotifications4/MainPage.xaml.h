...
namespace winrt::CppPackagedAppNotifications4::implementation
{
    ...
    {
        MainPage();
        static CppPackagedAppNotifications4::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<CppPackagedAppNotifications4::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static CppPackagedAppNotifications4::MainPage current;
    };
}
