...
cppwinrt_generate_headers(
    WINMD_GLOBS
    "${CURRENT_PACKAGES_DIR}/lib/Microsoft.Web.WebView2.Core.winmd")

file(COPY "${CMAKE_CURRENT_LIST_DIR}/webview2-config.cmake"
    DESTINATION "${CURRENT_PACKAGES_DIR}/share/webview2")
