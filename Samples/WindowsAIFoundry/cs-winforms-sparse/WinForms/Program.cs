...
namespace WindowsAISample
{
    internal static class Program
    {
        ...
        private static async Task RegisterSparsePackage()
        {
            ...
            string sparsePkgPath = exePath + "\\WindowsAISampleForWinFormsSparse.msix";

            Uri externalUri = new Uri(externalLocation!);
            Uri packageUri = new Uri(sparsePkgPath);

            PackageManager packageManager = new PackageManager();
            int count = packageManager.FindPackagesForUserWithPackageTypes("", "WindowsAISampleForWinFormsSparse_k0t3h69cz9sxw", PackageTypes.Main).Count();
            if (count == 0)
            {
        ...
        private static void RunWithIdentity()
        {
            ...
            string appUserModelId = "WindowsAISampleForWinFormsSparse_k0t3h69cz9sxw!WindowsAISampleForWinFormsSparsePkg";
