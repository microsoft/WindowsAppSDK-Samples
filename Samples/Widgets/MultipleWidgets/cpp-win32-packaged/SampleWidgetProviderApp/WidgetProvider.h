...
private:
	...
	std::shared_ptr<WidgetImpl> InitializeWidgetInternal(winrt::Microsoft::Windows::Widgets::Providers::WidgetContext widgetContext, winrt::hstring state);
	std::shared_ptr<WidgetImpl> FindRunningWidget(winrt::hstring widgetId);

	static std::unordered_map<winrt::hstring, std::shared_ptr<WidgetImpl>> m_runningWidgetImpl;
};
