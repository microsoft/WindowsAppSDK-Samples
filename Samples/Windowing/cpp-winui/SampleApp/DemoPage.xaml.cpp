...
namespace winrt::SampleApp::implementation
{
    ...
    void DemoPage::TitleBtn_Click([[maybe_unused]] winrt::Windows::Foundation::IInspectable const& sender, [[maybe_unused]] winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
    {
        m_mainAppWindow.Title(TitleTextBox().Text());
    }

    void DemoPage::SizeBtn_Click([[maybe_unused]] winrt::Windows::Foundation::IInspectable const& sender, [[maybe_unused]] winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
    {
        int windowWidth = 0;
        int windowHeight = 0;
