...
{
    /// <summary>
    /// Demonstrates how to connect to a Serial Device and respond to device disconnects.
    /// 
    ...
    public sealed partial class Scenario1_ConnectDisconnect : Page
    {
        ...
        private void InitializeDeviceWatchers()
        {
            ...
            // Allow the EventHandlerForDevice to handle device watcher events that relate to our device (i.e. device removal and addition)
