...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario2_DeviceCapture : Page
    {
        ...
        private async Task SelectOutputFile()
        {
            ...
            WinRT.Interop.InitializeWithWindow.Initialize(saveFilePicker, WinRT.Interop.WindowNative.GetWindowHandle(App.MainWindow));
            ...
            if (fileOutputNodeResult.Status != AudioFileNodeCreationStatus.Success)
            {
                ...
                fileButton.Background = new SolidColorBrush(Microsoft.UI.Colors.Red);
                return;
            }

            fileOutputNode = fileOutputNodeResult.FileOutputNode;
            fileButton.Background = new SolidColorBrush(Microsoft.UI.Colors.YellowGreen);
        ...
        private async Task ToggleRecordStop()
        {
            if (recordStopButton.Content.Equals("Record"))
            {
                ...
                audioPipe1.Fill = new SolidColorBrush(Microsoft.UI.Colors.Blue);
                audioPipe2.Fill = new SolidColorBrush(Microsoft.UI.Colors.Blue);
            }
            else if (recordStopButton.Content.Equals("Stop"))
            {
                // Good idea to stop the graph to avoid data loss
                graph.Stop();
                audioPipe1.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
                audioPipe2.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
        ...
        private async Task CreateAudioGraph()
        {
            ...
            if (deviceOutputNodeResult.Status != AudioDeviceNodeCreationStatus.Success)
            {
                ...
                outputDeviceContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Red);
                return;
            }

            deviceOutputNode = deviceOutputNodeResult.DeviceOutputNode;
            rootPage.NotifyUser("Device Output connection successfully created", NotifyType.StatusMessage);
            outputDeviceContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
            ...
            if (deviceInputNodeResult.Status != AudioDeviceNodeCreationStatus.Success)
            {
                ...
                inputDeviceContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Red);
                return;
            }

            deviceInputNode = deviceInputNodeResult.DeviceInputNode;
            rootPage.NotifyUser("Device Input connection successfully created", NotifyType.StatusMessage);
            inputDeviceContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
        ...
        private void Graph_UnrecoverableErrorOccurred(AudioGraph sender, AudioGraphUnrecoverableErrorOccurredEventArgs args)
        {
            ...
            this.DispatcherQueue.TryEnqueue(async () =>
            {
                ...
                recordStopButton.IsEnabled = false;
                recordStopButton.Content = "Record";
                outputDeviceContainer.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                audioPipe1.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
                audioPipe2.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
            });
        }
        ...
        private void outputDevicesListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                createGraphButton.IsEnabled = false;
                outputDevice.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 110, 110, 110));
                outputDeviceContainer.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                fileButton.IsEnabled = false;
                fileButton.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                inputDeviceContainer.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
            ...
            else
            {
                ...
                outputDevice.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
            }
        }
