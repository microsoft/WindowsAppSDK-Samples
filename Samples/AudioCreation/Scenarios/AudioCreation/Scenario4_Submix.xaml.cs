...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario4_Submix : Page
    {
        ...
        private async void File1_Click(object sender, RoutedEventArgs e)
        {
            ...
            fileButton1.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
        }
        ...
        private async void File2_Click(object sender, RoutedEventArgs e)
        {
            ...
            fileButton2.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
        }
        ...
        private void TogglePlay()
        {
            if (graphButton.Content.Equals("Start Graph"))
            {
                ...
                audioPipe3.Fill = new SolidColorBrush(Microsoft.UI.Colors.Blue);
                if (fileInputNode1 != null)
                {
                    audioPipe1.Fill = new SolidColorBrush(Microsoft.UI.Colors.Blue);
                }
            ...
            else if (graphButton.Content.Equals("Stop Graph"))
            {
                ...
                audioPipe3.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
            }
        }
        ...
        private async Task CreateAudioGraph()
        {
            ...
            submixNodeContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
