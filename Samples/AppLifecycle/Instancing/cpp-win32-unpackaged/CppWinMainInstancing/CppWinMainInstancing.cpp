    ...
    _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Initialize WASDK unpackaged apps.
...
bool DecideRedirection()
{
    ...
    else if (kind == ExtendedActivationKind::File)
    {
        ...
        // BUG: Seems we can only register one key, and fail thereafter.
        try
        {
...
void UnregisterForFileActivation()
{
    ...
    try
    {
        // We put this in a try block, because if the specified path is invalid,
        // this will throw ERROR_FILE_NOT_FOUND.
        hstring imageFileTypes[1] = { L".moo" };
