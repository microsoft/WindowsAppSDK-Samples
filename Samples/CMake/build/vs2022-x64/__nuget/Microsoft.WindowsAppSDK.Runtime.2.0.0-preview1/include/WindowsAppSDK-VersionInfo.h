...
#define WINDOWSAPPSDK_RELEASE_PATCH                         260211
...
#define WINDOWSAPPSDK_RUNTIME_VERSION_MINOR             772u
#define WINDOWSAPPSDK_RUNTIME_VERSION_BUILD             1552u
#define WINDOWSAPPSDK_RUNTIME_VERSION_REVISION          0u
#define WINDOWSAPPSDK_RUNTIME_VERSION_UINT64            0x0000030406100000u
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING     "0.772.1552.0"
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING_W   L"0.772.1552.0"

#define WINDOWSAPPSDK_RUNTIME_PACKAGE_FRAMEWORK_PACKAGEFAMILYNAME   "Microsoft.WindowsAppRuntime.2.0-preview1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_FRAMEWORK_PACKAGEFAMILYNAME_W L"Microsoft.WindowsAppRuntime.2.0-preview1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_MAIN_PACKAGEFAMILYNAME        "MicrosoftCorporationII.WinAppRuntime.Main.2.0-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_MAIN_PACKAGEFAMILYNAME_W      L"MicrosoftCorporationII.WinAppRuntime.Main.2.0-p1_8wekyb3d8bbwe"
...
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x8-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x8-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x6-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x6-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME      "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-a6-p1_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME_W    L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-a6-p1_8wekyb3d8bbwe"
...
#define WAS_RELEASE_PATCH               260211
...
#define WASR_VERSION_MINOR              772
#define WASR_VERSION_BUILD              1552
#define WASR_VERSION_REVISION           0
#define WASR_VERSION_UINT64             0x0000030406100000
#define WASR_VERSION_DOTQUADSTRING      "0.772.1552.0"
#define WASR_VERSION_DOTQUADSTRING_W    L"0.772.1552.0"

#define WASR_PKG_FRAMEWORK_FAMILY       "Microsoft.WindowsAppRuntime.2.0-preview1_8wekyb3d8bbwe"
#define WASR_PKG_FRAMEWORK_FAMILY_W     L"Microsoft.WindowsAppRuntime.2.0-preview1_8wekyb3d8bbwe"
#define WASR_PKG_MAIN_FAMILY            "MicrosoftCorporationII.WinAppRuntime.Main.2.0-p1_8wekyb3d8bbwe"
#define WASR_PKG_MAIN_FAMILY_W          L"MicrosoftCorporationII.WinAppRuntime.Main.2.0-p1_8wekyb3d8bbwe"
...
#define WASR_PKG_DDLM_X86_FAMILY        "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x8-p1_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X86_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x8-p1_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY        "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x6-p1_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x6-p1_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY      "Microsoft.WinAppRuntime.DDLM.0.772.1552.0-a6-p1_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY_W    L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-a6-p1_8wekyb3d8bbwe"
#endif
    ...
    namespace Runtime
    {
        ...
        namespace Packages
        {
            namespace Framework
            {
                ...
                constexpr PCWSTR PackageFamilyName = L"Microsoft.WindowsAppRuntime.2.0-preview1_8wekyb3d8bbwe";
            }
            namespace Main
            {
                /// The Windows App SDK runtime's Main package's family name.
                constexpr PCWSTR PackageFamilyName = L"MicrosoftCorporationII.WinAppRuntime.Main.2.0-p1_8wekyb3d8bbwe";
            }
            namespace Singleton
            {
            ...
            namespace DDLM
            {
                namespace X86
                {
                    ...
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x8-p1_8wekyb3d8bbwe";
                }
                namespace X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-x6-p1_8wekyb3d8bbwe";
                }
                namespace Arm64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for arm64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.0.772.1552.0-a6-p1_8wekyb3d8bbwe";
                }
            }
        }
    }
