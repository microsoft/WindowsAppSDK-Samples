...
public sealed partial class Scenario4_ShowView : Page
{
    ...
    private void TextBox_GotFocus(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            {
                MainWindow.Current?.NotifyUser(
                    "The emoji keyboard scenario requires package identity. Run the sample using its packaged profile.",
    ...
    private static bool HasPackageIdentity()
    {
        ...
        return result switch
        {
            ...
            _ => throw new InvalidOperationException($"Unable to determine package identity. Error: {result}."),
        };
    }
