    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
            //      StaticSampleName                                                Class                                 SampleType            SampleCategory                      Effects     FastEffects     ThumbnailURL                                                                         StaticSampleDescription                                                   Date Added                              Featured                   Tags
                ...
                //new SampleDefinition(VideoPlayground.StaticSampleName,              typeof(VideoPlayground),              SampleType.Reference, SampleCategory.APIReference,        true,       true,           "ms-appx:///Assets/SampleThumbnails/VideoPlayground.PNG",                   description: VideoPlayground.StaticSampleDescription),
                ...
                //new SampleDefinition(SwipeScroller.StaticSampleName,                typeof(SwipeScroller),                SampleType.EndToEnd,  SampleCategory.Motion,              false,      false,          "ms-appx:///Assets/SampleThumbnails/SwipeScroller.PNG",                     description: SwipeScroller.StaticSampleDescription                                dateAdded: new DateTime(2017,03,05),    featured: true),
                ...
                //new SampleDefinition(TransparentWindow.StaticSampleName,            typeof(TransparentWindow),            SampleType.EndToEnd,  SampleCategory.APIReference,        true,       true,           "ms-appx:///Assets/SampleThumbnails/TransparentWindow.PNG",                 description: TransparentWindow.StaticSampleDescription                            dateAdded: new DateTime(2017,02,08),    featured: true),
                ...
                //new SampleDefinition(ShowHideImplicitWebview.StaticSampleName,      typeof(ShowHideImplicitWebview),      SampleType.EndToEnd,  SampleCategory.Motion,              false,      false,          "ms-appx:///Assets/SampleThumbnails/ShowHideImplicitWebview.PNG",           description: ShowHideImplicitWebview.StaticSampleDescription                      dateAdded: new DateTime(2017,02,28)),
