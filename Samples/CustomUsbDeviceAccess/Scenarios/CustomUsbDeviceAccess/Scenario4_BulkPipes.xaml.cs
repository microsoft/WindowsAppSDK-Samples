...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario4_BulkPipes : Page, IDisposable
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs eventArgs)
        {
            ...
            // Reset the buttons if the device is reconnected
        ...
        private async void BulkRead_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private async void BulkWrite_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
                try
        ...
        private async void BulkReadWrite_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
                try
        ...
        private void CancelAllIoTasks_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
                CancelAllIoTasks();
