...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario2_ControlTransfer : Page
    {
        ...
        private async void GetOsrFx2SevenSegmentSetting_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        async void SetOsrFx2SevenSegmentSetting_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
        ...
        async void GetSuperMuttLedBlinkPattern_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
        ...
        async void SetSuperMuttLedBlinkPattern_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
