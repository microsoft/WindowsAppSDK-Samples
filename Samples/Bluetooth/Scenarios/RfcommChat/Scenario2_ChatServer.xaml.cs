...
namespace SDKTemplate
{
    public sealed partial class Scenario2_ChatServer : Page
    {
        ...
        private async void InitializeRfcommServer()
        {
            ...
            try
            {
                rfcommProvider = await RfcommServiceProvider.CreateAsync(RfcommServiceId.FromUuid(RfcommChatConstants.RfcommChatServiceUuid));
            }
        ...
        private void InitializeServiceSdpAttributes(RfcommServiceProvider rfcommProvider)
        {
            ...
            sdpWriter.WriteByte(RfcommChatConstants.SdpServiceNameAttributeType);

            // The length of the UTF-8 encoded Service Name SDP Attribute.
            sdpWriter.WriteByte((byte)RfcommChatConstants.SdpServiceName.Length);

            // The UTF-8 encoded Service Name value.
            sdpWriter.UnicodeEncoding = Windows.Storage.Streams.UnicodeEncoding.Utf8;
            sdpWriter.WriteString(RfcommChatConstants.SdpServiceName);

            // Set the SDP Attribute on the RFCOMM Service Provider.
            rfcommProvider.SdpRawAttributes.Add(RfcommChatConstants.SdpServiceNameAttributeId, sdpWriter.DetachBuffer());
        }
