...
namespace winrt::ConditionalXamlPredicate::implementation
{
    ...
    {
        MainPage();
        static ConditionalXamlPredicate::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<ConditionalXamlPredicate::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static ConditionalXamlPredicate::MainPage current;
    };
}
