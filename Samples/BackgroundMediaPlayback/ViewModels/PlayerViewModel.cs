...
namespace SDKTemplate.ViewModels
{
    ...
    public class PlayerViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public PlayerViewModel(MediaPlayer player, DispatcherQueue dispatcher)
        {
            this.player = player;
        ...
        private void Items_VectorChanged(IObservableVector<MediaPlaybackItem> sender, IVectorChangedEventArgs args)
        {
            if (disposed) return;
