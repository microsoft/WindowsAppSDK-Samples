...
{
    public sealed partial class Scenario1_ProximitySensorDataEvents : Page
    {
        ...
        public Scenario1_ProximitySensorDataEvents()
        {
        ...
        /// <param name="e"></param>
        private void ReadingChanged(ProximitySensor sender, ProximitySensorReadingChangedEventArgs e)
        {
            DispatcherQueue.TryEnqueue(() =>
            {
