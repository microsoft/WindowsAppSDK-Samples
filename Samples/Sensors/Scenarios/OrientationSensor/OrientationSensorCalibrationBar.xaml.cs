...
{
    public sealed partial class OrientationSensorCalibrationBar : Page
    {
        ...
        public OrientationSensorCalibrationBar()
        {
        ...
        public void RequestCalibration(MagnetometerAccuracy accuracy)
        {
            ...
            {
                CalibrationPopup.XamlRoot = App.MainWindow.Content.XamlRoot;
                InvalidateLayout();
        ...
        {
            CalibrationGrid.Width = App.MainWindow.Content.XamlRoot.Size.Width;
        ...
        {
            if (Guidance.Visibility == Visibility.Collapsed)
            {
                ShowGuidance();
            }
        }
        ...
        {
            if (Guidance.Visibility == Visibility.Visible)
            {
                HideGuidance();
            }
        }
        ...
        {
            ShowGuidanceButton.Visibility = Visibility.Collapsed;
            HideGuidanceButton.Visibility = Visibility.Visible;
        ...
        {
            HideGuidanceButton.Visibility = Visibility.Collapsed;
            ShowGuidanceButton.Visibility = Visibility.Visible;
