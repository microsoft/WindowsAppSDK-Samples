...
{
    public sealed partial class Scenario3_PresenceSensorChoosing : Page
    {
        ...
        public Scenario3_PresenceSensorChoosing()
        {
            InitializeComponent();
        }
        ...
        private void OnHumanPresenceSensorAdded(DeviceWatcher sender, DeviceInformation deviceInfo)
        {
        ...
        private void OnHumanPresenceSensorRemoved(DeviceWatcher sender, DeviceInformationUpdate update)
        {
            DispatcherQueue.TryEnqueue(() =>
            {
        ...
        private void OnHumanPresenceSensorUpdated(DeviceWatcher sender, DeviceInformationUpdate update)
        {
            DispatcherQueue.TryEnqueue(() =>
            {
        ...
        private void OnHumanPresenceSensorEnumerationCompleted(DeviceWatcher sender, object e)
        {
            DispatcherQueue.TryEnqueue(() =>
            {
