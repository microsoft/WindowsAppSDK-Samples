...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario5_InboxEffects : Page
    {
        ...
        private async void File_Click(object sender, RoutedEventArgs e)
        {
            ...
            fileButton.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
        ...
        private void TogglePlay()
        {
            if (graphButton.Content.Equals("Start Graph"))
            {
                ...
                audioPipe.Fill = new SolidColorBrush(Microsoft.UI.Colors.Blue);
            }
            else
            {
                graph.Stop();
                graphButton.Content = "Start Graph";
                audioPipe.Fill = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 49, 49, 49));
            }
        }
        ...
        private void EchoEffectToggle_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            if (echoEffectToggle.IsOn)
            {
                ...
                echoLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                fileInputNode.EnableEffectsByDefinition(echoEffectDefinition);
            }
            else
            {
                echoSlider.IsEnabled = false;
                echoLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255,74,74,74));
        ...
        private void ReverbEffectToggle_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            if (reverbEffectToggle.IsOn)
            {
                ...
                decayLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                fileInputNode.EnableEffectsByDefinition(reverbEffectDefinition);
            }
            else
            {
                decaySlider.IsEnabled = false;
                decayLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
        ...
        private void LimiterEffectToggle_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            if (limiterEffectToggle.IsOn)
            {
                ...
                loudnessLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                fileInputNode.EnableEffectsByDefinition(limiterEffectDefinition);
            }
            else
            {
                loudnessSlider.IsEnabled = false;
                loudnessLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
        ...
        private void EqToggle_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            if (eqToggle.IsOn)
            {
                ...
                eq1SliderLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                eq2SliderLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                eq3SliderLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
                eq4SliderLabel.Foreground = new SolidColorBrush(Microsoft.UI.Colors.White);
            ...
            else
            {
                ...
                eq1SliderLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                eq2SliderLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                eq3SliderLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
                eq4SliderLabel.Foreground = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 74, 74, 74));
        ...
        private async Task CreateAudioGraph()
        {
            ...
            if (outputDeviceNodeResult.Status != AudioDeviceNodeCreationStatus.Success)
            {
                ...
                speakerContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Red);
                return;
            }
            ...
            speakerContainer.Background = new SolidColorBrush(Microsoft.UI.Colors.Green);
        }
    }
}