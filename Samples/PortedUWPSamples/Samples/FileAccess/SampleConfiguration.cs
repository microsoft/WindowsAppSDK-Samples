...
namespace SDKTemplate
{
    public partial class MainPage : Microsoft.UI.Xaml.Controls.Page
    {
        ...
        {
            new FeatureGroup("File access", new()
            {
                new Scenario { Title = "Creating a file", ClassType = typeof(Scenario1) },
                new Scenario { Title = "Getting a file's parent folder", ClassType = typeof(Scenario2) },
                new Scenario { Title = "Writing and reading text in a file", ClassType = typeof(Scenario3) },
                new Scenario { Title = "Writing and reading bytes in a file", ClassType = typeof(Scenario4) },
                new Scenario { Title = "Writing and reading using a stream", ClassType = typeof(Scenario5) },
                new Scenario { Title = "Displaying file properties", ClassType = typeof(Scenario6) },
                new Scenario { Title = "Persisting access to a storage item for future use", ClassType = typeof(Scenario7) },
                new Scenario { Title = "Copying a file", ClassType = typeof(Scenario8) },
                new Scenario { Title = "Comparing two files to see if they are the same file", ClassType = typeof(Scenario9) },
                new Scenario { Title = "Deleting a file", ClassType = typeof(Scenario10) },
                new Scenario { Title = "Attempting to get a file with no error on failure", ClassType = typeof(Scenario11) },
            }),
        };
