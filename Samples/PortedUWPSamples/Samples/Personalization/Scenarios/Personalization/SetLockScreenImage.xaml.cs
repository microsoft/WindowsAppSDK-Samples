...
namespace SDKTemplate
{
    public sealed partial class SetLockScreenImage : Page
    {
        ...
        private async void PickAndSetButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // WinUI 3 desktop apps must associate the picker with the app window.
            WinRT.Interop.InitializeWithWindow.Initialize(imagePicker, WinRT.Interop.WindowNative.GetWindowHandle(App.MainWindow));
