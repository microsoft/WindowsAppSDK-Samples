...
namespace SDKTemplate
{
    public sealed partial class Scenario1_CameraManualControls : Page
    {
        ...
        private void UpdateEvControlCapabilities()
        {
            ...
            {
                EvButton.IsEnabled = false;
                EvButton.Tag = Visibility.Visible;
            }
        }

        private async void EvSlider_ValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
