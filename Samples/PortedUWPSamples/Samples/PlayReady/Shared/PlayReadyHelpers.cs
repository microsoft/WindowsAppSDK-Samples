...
namespace SDKTemplate.Shared
{
    ...
    // Proactive helpers will configure a request and use the Reactive method for the call.
    class PlayReadyHelpers
    {
        ...
        static public MediaProtectionManager InitializeProtectionManager(ServiceRequestedEventHandler serviceRequestHandler)
        {
            ...
            // Windows provides built in support for Dash and does not require additional configuration. 
            // This would be a good place to configure a MediaExtensionManager to support another stream source 
        ...
        /// This an infrequent event that may be triggered by a pending OS update in which DRM components 
        ...
        /// request from PlayReady. This enables the app to manage when activation occurs.
        /// </summary>
        ...
        /// <summary>
        /// The application can proactively request a license by creating a license request and 
