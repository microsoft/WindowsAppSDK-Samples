...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario1_MIDIDeviceEnumeration : Page
    {
        ...
        public Scenario1_MIDIDeviceEnumeration()
        {
            ...
            this.midiInDeviceWatcher = new MidiDeviceWatcher(MidiInPort.GetDeviceSelector(), this.DispatcherQueue, this.inputDevices);
            this.midiOutDeviceWatcher = new MidiDeviceWatcher(MidiOutPort.GetDeviceSelector(), this.DispatcherQueue, this.outputDevices);
