...
namespace MIDI
{
    ...
    internal class MidiDeviceWatcher
    {
        ...
        /// <param name="dispatcher">DispatcherQueue instance, to update UI thread</param>
        /// <param name="portListBox">The UI element to update with list of devices</param>
        internal MidiDeviceWatcher(string midiSelectorString, DispatcherQueue dispatcherQueue, ListBox portListBox)
        {
