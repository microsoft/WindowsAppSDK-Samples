...
namespace SDKTemplate
{
    ...
    public sealed partial class FeatureReports : Page
    {
        ...
        async void GetLedBlinkPattern_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        async void SetLedBlinkPattern_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
