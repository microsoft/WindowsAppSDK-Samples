...
{
    /// <summary>
    /// Demonstrates how to connect to a Hid device and respond to device disconnects.
    ///
    ...
    public sealed partial class DeviceConnect : Page
    {
        ...
        ///
        /// The UI elements are controlled/modified through device watcher events, device opening/closing
        /// </summary>
        ...
        /// <summary>
        /// Unregister from DeviceWatcher events because this page will be unloaded.
        /// </summary>
        ...
        private void InitializeDeviceWatchers()
        {
            ...
            // Allow the EventHandlerForDevice to handle device watcher events that relates or effects our device (i.e. device removal and addition)
