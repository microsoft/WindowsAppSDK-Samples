...
{
    /// <summary>
    /// The purpose of this class is to demonstrate what to do to a HidDevice when it is disconnected.
    ///
    ...
    public class EventHandlerForDevice
    {
        ...
        /// <summary>
        /// Closes the device, stops the device watcher, and resets object state to before a device
        /// was ever connected.
        /// </summary>
