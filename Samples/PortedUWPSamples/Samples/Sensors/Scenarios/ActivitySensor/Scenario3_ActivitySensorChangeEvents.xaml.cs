...
{
    public sealed partial class Scenario3_ActivitySensorChangeEvents : Page
    {
        ...
        public Scenario3_ActivitySensorChangeEvents()
        {
        ...
        /// <param name="e"></param>
        private void ReadingChanged(object sender, ActivitySensorReadingChangedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AccessChanged(DeviceAccessInformation sender, DeviceAccessChangedEventArgs e)
        {
            var status = e.Status;
