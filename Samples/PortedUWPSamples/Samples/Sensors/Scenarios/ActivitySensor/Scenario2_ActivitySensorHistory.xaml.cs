...
{
    public sealed partial class Scenario2_ActivitySensorHistory : Page
    {
        ...
        public Scenario2_ActivitySensorHistory()
        {
        ...
        /// <param name="e"></param>
        private async void ScenarioGetActivityHistory(object sender, RoutedEventArgs e)
        {
