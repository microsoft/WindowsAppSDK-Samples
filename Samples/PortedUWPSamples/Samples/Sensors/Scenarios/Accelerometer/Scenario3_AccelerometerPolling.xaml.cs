...
{
    public sealed partial class Scenario3_AccelerometerPolling : Page
    {
        ...
        public Scenario3_AccelerometerPolling()
        {
        ...
        private void DisplayCurrentReading(object sender, object args)
        {
            ...
            if (reading != null)
            {
                AccelerometerHelper.SetReadingText(ScenarioOutput, reading);
            }
        }
