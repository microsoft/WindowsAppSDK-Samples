...
{
    public sealed partial class Scenario5_AccelerometerDataEventsBatching : Page
    {
        ...
        public Scenario5_AccelerometerDataEventsBatching()
        {
        ...
        {
            accelerometer = Accelerometer.GetDefault(AccelerometerHelper.ReadingType);
        ...
        private void ReadingChanged(object sender, AccelerometerReadingChangedEventArgs e)
        {
            ...
            {
                AccelerometerHelper.SetReadingText(ScenarioOutput, e.Reading);
            });
        }
