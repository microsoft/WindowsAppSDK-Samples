...
namespace SDKTemplate
{
    ...
    /// </summary>
    public sealed partial class Scenario5_MulticastAndBroadcast : Page
    {
        ...
        public Scenario5_MulticastAndBroadcast()
        {
        ...
        {
            App.MainDispatcherQueue.TryEnqueue(() => rootPage.NotifyUser(strMessage, type));
        }
    }
}