...
{
    /// <summary>
    /// The purpose of this class is to demonstrate the expected application behavior when the device is disconnected.
    /// 
    ...
    public class EventHandlerForDevice
    {
        ...
        /// <summary>
        /// Enforces the singleton pattern so that there is only one object handling device events
        ...
        /// on the UI thread.
        /// 
        /// This method is used to reopen the device after the device reconnects to the computer.
        /// </summary>
        ...
        /// <summary>
        /// Closes the device, stops the device watcher, and resets object state to before a device was ever connected.
        /// </summary>
