...
namespace SDKTemplate
{
    public sealed partial class Scenario1 : Page
    {
        ...
        {
            pressedTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.RoyalBlue);
        ...
        {
            pressedTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
        ...
        {
            enterExitTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.RoyalBlue);
        ...
        {
            enterExitTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
        ...
        {
            tapTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.DeepSkyBlue);
        ...
        {
            tapTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.RoyalBlue);
        ...
        {
            holdTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.RoyalBlue);
        ...
        void target_Holding(object sender, HoldingRoutedEventArgs e)
        {
            ...
            {
                holdTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.DeepSkyBlue);
                holdTargetText.Text = "Holding";
            }
            else if (e.HoldingState == Microsoft.UI.Input.HoldingState.Completed)
            {
                holdTarget.Background = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
