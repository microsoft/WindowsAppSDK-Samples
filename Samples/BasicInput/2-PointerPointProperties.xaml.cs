...
namespace SDKTemplate
{
    public sealed partial class Scenario2 : Page
    {
        ...
        {
            Microsoft.UI.Input.PointerPoint currentPoint = e.GetCurrentPoint(mainCanvas);
        ...
        void CreateOrUpdatePropertyPopUp(Microsoft.UI.Input.PointerPoint currentPoint)
        {
        ...
        String GetPointerProperties(Microsoft.UI.Input.PointerPoint currentPoint)
        {
        ...
        String GetDeviceSpecificProperties(Microsoft.UI.Input.PointerPoint currentPoint)
        {
        ...
        String GetMouseProperties(Microsoft.UI.Input.PointerPoint currentPoint)
        {
            Microsoft.UI.Input.PointerPointProperties pointerProperties = currentPoint.Properties;
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        String GetTouchProperties(Microsoft.UI.Input.PointerPoint currentPoint)
        {
            Microsoft.UI.Input.PointerPointProperties pointerProperties = currentPoint.Properties;
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        String GetPenProperties(Microsoft.UI.Input.PointerPoint currentPoint)
        {
            Microsoft.UI.Input.PointerPointProperties pointerProperties = currentPoint.Properties;
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        // Popup UI code below
        //
        void RenderPropertyPopUp(String pointerProperties, String deviceSpecificProperties, Microsoft.UI.Input.PointerPoint currentPoint)
        {
            ...
            else
            {
                ...
                {
                    case Microsoft.UI.Input.PointerDeviceType.Mouse:
                        deviceSpecificText.Foreground = new SolidColorBrush(Microsoft.UI.Colors.Red);
                        break;

                    case Microsoft.UI.Input.PointerDeviceType.Touch:
                        deviceSpecificText.Foreground = new SolidColorBrush(Microsoft.UI.Colors.Green);
                        break;

                    case Microsoft.UI.Input.PointerDeviceType.Pen:
                        deviceSpecificText.Foreground = new SolidColorBrush(Microsoft.UI.Colors.Yellow);
                        break;
                }
        ...
        void HidePropertyPopUp(Microsoft.UI.Input.PointerPoint currentPoint)
        {
            if (popups.ContainsKey(currentPoint.PointerId))
            {
