...
namespace SDKTemplate
{
    public sealed partial class Scenario4 : Page
    {
        ...
        {
            forceManipulationsToEnd = false;
            manipulateMe.Background = new SolidColorBrush(Microsoft.UI.Colors.DeepSkyBlue);
        }
        ...
        {
            manipulateMe.Background = new SolidColorBrush(Microsoft.UI.Colors.RoyalBlue);
        }

        // When a manipulation has finished, reset the color of the object
        void ManipulateMe_ManipulationCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
            manipulateMe.Background = new SolidColorBrush(Microsoft.UI.Colors.LightGray);
        }
