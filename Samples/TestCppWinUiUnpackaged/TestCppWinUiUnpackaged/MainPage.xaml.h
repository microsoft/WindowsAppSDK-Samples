...
namespace winrt::TestCppWinUiUnpackaged::implementation
{
    ...
    {
        MainPage();
        static TestCppWinUiUnpackaged::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<TestCppWinUiUnpackaged::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static TestCppWinUiUnpackaged::MainPage current;
    };
}
