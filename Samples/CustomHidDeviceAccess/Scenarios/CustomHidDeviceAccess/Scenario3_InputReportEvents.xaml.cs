...
namespace SDKTemplate
{
    ...
    public sealed partial class InputReportEvents : Page
    {
        ...
        private void RegisterForInputReportEvents_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
        ...
        private void UnregisterFromInputReportEvents_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
                UnregisterFromInputReportEvent();
        ...
        private void OnInputReportEvent(HidDevice sender, HidInputReportReceivedEventArgs eventArgs)
        {
            ...
            if (!navigatedAway)
            {
                ...
                // Queue to the UI thread because we are interacting with the UI directly and the
