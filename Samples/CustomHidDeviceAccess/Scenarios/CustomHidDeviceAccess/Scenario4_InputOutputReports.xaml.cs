...
namespace SDKTemplate
{
    ...
    public sealed partial class InputOutputReports : Page
    {
        ...
        private async void GetNumericInputReport_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
        ...
        private async void SendNumericOutputReport_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
        ...
        private async void GetBooleanInputReport_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
                // Don't allow multiple reads at the same time
        ...
        private async void SendBooleanOutputReport_Click(Object sender, Microsoft.UI.Xaml.RoutedEventArgs eventArgs)
        {
            if (EventHandlerForDevice.Current.IsDeviceConnected)
            {
