...
namespace SDKTemplate.ViewModels
{
    public class ProactiveViewModel : ViewModelBase
    {
        ...
        // The content associated with the above KeyId
        ...
        /// <summary>
        /// A view model class for the Proactive Scenario.
        /// </summary>
        public ProactiveViewModel(MediaPlayerElement mediaElement)
        {
            ...
            /// Proactive license acquisition will ensure a license is available
            /// prior to playback
            ...
            /// Proactive individualization will ensure PlayReady has been configured
            /// to begin making license requests
            IndividualizeIfNeeded();
        }

        /// A check is made to see if the device has been initialized and an indiv
        ...
        {
            // return false if app is not initialized 
        ...
        // The ServiceRequested and ProcessServiceRequest methods are not used in this 
        ...
        // requests which would use these methods.
