...
namespace winrt::EmptyWinUICppTemplate::implementation
{
    ...
    {
        MainPage();
        static EmptyWinUICppTemplate::MainPage Current() { return current; }
        static Windows::Foundation::Collections::IVector<EmptyWinUICppTemplate::Scenario> Scenarios() { return scenariosInner; }
    ...
    private:
        ...
        static EmptyWinUICppTemplate::MainPage current;
    };
}
